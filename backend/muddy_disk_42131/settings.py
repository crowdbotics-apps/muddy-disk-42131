"""
Django settings for muddy_disk_42131 project.
...
ROOT_URLCONF = 'muddy_disk_42131.urls'
...
WSGI_APPLICATION = 'muddy_disk_42131.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "muddy_disk_42131 API",
    "DESCRIPTION": "API documentation for muddy_disk_42131 App",
    "VERSION": "v1",
}
